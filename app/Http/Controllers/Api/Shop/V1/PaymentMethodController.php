...
class PaymentMethodController extends Controller
{
    ...
    public function __construct(PaymentMethodRepository $payment_methodRepo)
    {
        $this->payment_methodRepo = $payment_methodRepo;
    }
    public function index(Request $request)
    {
        $this->payment_methodRepo->setFilters($request->all());
        $payment_methods = $this->payment_methodRepo->all();
