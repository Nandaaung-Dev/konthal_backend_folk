<script setup>
	...
	const createPaymentMethod = () => {
		form.post(route("system_dashboard.payment_methods.store"), {
			errorBag: "createPaymentMethod",
			preserveScroll: true,
		});
	};
</script>
<template>
	<AppLayout title="PaymentMethod">
		<template #header>
			<FormHeader title="Create PaymentMethod Form" />
		</template>
		<FormSection @submit.prevent="createPaymentMethod">
			<template #title>Create PaymentMethod</template>
