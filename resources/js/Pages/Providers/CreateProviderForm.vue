<script setup>
	...
	const createProvider = () => {
		form.post(route("system_dashboard.providers.store"), {
...
<template>
	<AppLayout title="Provider">
		<template #header>
			<FormHeader title="Create Provider Form" />
		</template>
		<FormSection @submit.prevent="createProvider">
			<template #title>Create Provider</template>
